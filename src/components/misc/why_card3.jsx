...
const Card2 = () => {
  return (
    <StyledWrapper data-aos="zoom-out" data-aos-delay="500">
      <div className="card">
        <div className="card-image" />
        <p className="card-title">Emergency Dental Care</p>
        <p className="card-text">
          Dental emergencies are unexpected. We offer fast, effective care to
          relieve pain and handle urgent issues.
        </p>
      </div>
    </StyledWrapper>
  );
