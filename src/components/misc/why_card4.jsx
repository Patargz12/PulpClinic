...
import { cosmetic } from "../../assets";

const Card4 = () => {
  return (
    <StyledWrapper data-aos="zoom-out" data-aos-delay="700">
      <div className="card">
        <div className="card-image" />
        <p className="card-title">Cosmetic Dentistry Expertise</p>
        <p className="card-text">
          Achieve the smile of your dreams with our cosmetic dental services,
